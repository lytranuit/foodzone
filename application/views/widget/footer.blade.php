        ...
        <div class="container-wide">
            <div class="row border-left-cell">
                <div class="col-12 col-lg-6">
                    ...
                    <p>{{lang("footer_phone")}}: <a class="text-dark"
                            href="tel:{{$options['hot_line']}}">{{$options['hot_line']}}</span></a></p>
                ...
                <div class="col-12 col-lg-3">
                    <ul class="list-inline" style="font-size: 25px;">
                        <li><a target="_blank" class="icon icon-xxs-mod-1 fab fa-facebook icon-facebook"
                                href="http://www.facebook.com/sharer/sharer.php?u={{current_url()}}"></a></li>
                        <li><a target="_blank" class="icon icon-xxs-mod-1 fab fa-twitter icon-twitter"
                                href="https://twitter.com/intent/tweet?text=Link&url={{current_url()}}"></a></li>
                        <li class="zalo-share-button" data-href="" data-oaid="579745863508352884" data-layout="2"
...
<div class="zalo-chat-widget" data-oaid="2343818110642891994" data-welcome-message="Rất vui khi được hỗ trợ bạn!"
